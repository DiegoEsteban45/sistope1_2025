...
//Entrada: pid del proceso
//Salida: 1 si el proceso no existe, 0 si existe
//Descrpción: Verifica si el proceso está muerto
...
//Entrada: un arrgelo de pids
//Salida: true si solo queda un proceso vivo, false si hay más de uno
//Descripción: Verifica si solo queda un proceso vivo
...
//Entrada: un arreglo de pids y su tamaño
//Salida: void
//Descripción: Imprime el arreglo de pids
...
//Entrada: un pid
//Salida: el pid del siguiente proceso vivo
//Descripción: Selecciona el siguiente proceso vivo en el anillo
